...
def validate_config(cfg):
    ...
    # a trusted LAN -- with it on, anyone who can reach the page can drive MQTT,
    # exactly like an anonymous broker (mosquitto's allow_anonymous).
    ...
    # stays display-only. Enabling it requires a web login OR
    # allow_anonymous_control; otherwise it is forced back off with a warning.
    ...
    # Arbitrary MQTT publishing from the web UI's console. Same posture: off by
    # default, and enabling it requires a web login OR allow_anonymous_control.
